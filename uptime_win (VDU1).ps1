...
function Update-Dashboard {
    ...
    # --- Retrieve OS Data ---
    # Kernel-accurate uptime (monotonic)
...
# =============================================================================
# POSITION FORM ON PRIMARY MONITOR (TOP-LEFT CORNER)
# =============================================================================
...
if ($null -eq $primary) {
    Write-Host "No primary monitor found � using first available screen" -ForegroundColor Yellow
...
# Debug output
Write-Host "Primary monitor: $($primary.DeviceName)" -ForegroundColor Magenta
